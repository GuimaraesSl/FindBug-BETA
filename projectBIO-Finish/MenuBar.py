...
class MenuB(gtk.Window):
	def __init__(self):
		...
		self.Adictional[5].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b> DANOS: O ORIUS INSIDIOSUS É UM IMPORTANTE PREDADOR DE MUITAS PRAGAS</span>")
		...
		self.Adictional[8].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: OS DANOS SÃO CAUSADOS PELAS LARVAS QUE ABRIGAM - SE NO INTERIOR DO RIZOMA E DANIFICAM OS TECIDOS. EM CONSEQUÊNCIA PODE OCORRER A MORTE DA PLANTA E FALHAS NAS BROTAÇÕES DAS SOQUEIRAS, COM PERDAS DE 20 A 30 TONELADAS DE CANA POR ANO.</span>")
		...
		self.Adictional[11].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: CAUSA DANOS Á FOLHAS, FLORES, FRUTOS, CASCA (TRONCO) /CORTIÇA. OS DANOS SÃO FEITOS POR MEIO DO CORTE DOS TECIDOS QUANDO ESTÃO À PROCURA DE UMA SUBSTÂNCIA PARA A CONSTRUÇÃO DO NINHO. DESTRUIÇÃO DE BOTÕES FLORAIS APRESENTANDO ORIFÍCIOS DE ALGUMAS PLANTAS, FERIMENTOS E DANIFICAÇÃO DOS FRUTOS, DESTRUIÇÃO DE CACHOS DE UVA, DANIFICAM BROTOS DE CITRUS (TODAS AS ESPÉCIES) E PODE OCASIONAR QUEDA DE FLORES.</span>")
		...
		self.Adictional[13].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DESCRIÇÃO: ASPECTO DE UMA PEQUENA TRAÇA, COM O CORPO E AS ASAS RECOBERTOS POR UMA FINA CAMADA DE PEQUENOS PELOS DE COLORAÇÃO CINZENTO-ACASTANHADA</span>")
		...
		self.Adictional[14].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b> ESSE ANIMAL É ORIGINÁRIO DO CONTINENTE AFRICANO MAS É CONSIDERADO UMA PESTE QUASE COSMOPOLITA. ESSA BARATA É COMUMENTE ENCONTRADA DENTRO DE RESIDÊNCIAS OU PRÓXIMO A ELAS.</span>")

		self.label[15].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>NOME CIENTÍFICO:</b> PERIPLANETA FULIGINOSA \n<b>NOMES COMUNS:</b>\nBARATA MARROM FULIGEM\nBANDA MARROM\nBANDA CAFÉ\n<b>ORDEM:</b> BLATTODEA\n<b>FAMÍLIA:</b> BLATTIDAE\n<b>SUBFAMÍLIA:</b> BLATTINAE\n<b>GÊNERO:</b> PERIPLANETA </span>")
		self.Adictional[15].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>EMBORA SEJA PARENTE DA BARATA-AMERICANA, A BARATA MARROM FULIGEM É FACILMENTE DESTINGUÍVEL PO SUA COLORAÇÃO MARROM ESCURA. ALÉM DO QUE, AO CONTRÁRIO DA PARATA-AMERICANA, QUE GERALMENTE POSSUI UM TÓRAX DE COR CLARA, A FULIGINOSA APRESENTA UM TOM AMARRONZADO E BRILHANTE NA MESMA REGIAO.</span>")
		...
		self.Adictional[16].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: AS LARVAS POSSUEM HÁBITOS SUBTERRÂNEOS, ATACANDO AS RAÍZES E TUBÉRCULOS DAS PLANTAS.  AS PLANTAS ATACADAS FICAM AMARELADAS, PODENDO MORRER DEVIDO À DESTRUIÇÃO QUE ESTES INSETOS CAUSAM ÀS RAÍZES. AS TOUCEIRAS ATACADAS SÃO FACILMENTE OBSERVADAS NO CAMPO.</span>")
		...
		self.Adictional[17].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: CAUSAM IMPORTANTES PREJUÍZOS AS PASTAGENS E LAVOURAS DE MILHO. FOLHAS PICADAS MOSTRAM ÁREAS CLORÓTICAS E COM SINAIS DE NECROSE, O QUE PODE LEVAR A MORTE DA PLANTA. PLANTAS NOVAS SÃO EXTREMAMENTE SENSÍVEIS AO ATAQUE DA PRAGA.</span>")
		...
		self.Adictional[18].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: DE MODO GERAL, DERMÁPTEROS NÃO SÃO APONTADOS COMO PRAGAS. </span>")
		...
		self.Adictional[19].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: ESSES INSETOS AFETAM AS CULTURAS DE ALGODÃO, GIRASSOL E SOJA. É CONHECIDO POR SER UMA DAS MAIS AGRESSIVAS PRAGAS DA CULTURA DA SOJA.</span>")
		...
		self.Adictional[20].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: É CONSIDERADA UMA PREDADORA GENERALISTA SE ALIMENTANDO DE UMA VARIEDADE DE INSETOS INCLUSIVE DE OUTROS INSETOS E PRAGAS COMO A BROCA DE CANA.</span>")
		...
		self.Adictional[21].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: AS CULTURAS AFETADAS SÃO ABÓBORA, CAJU, MILHO, SORGO, ROMÃ, CARAMBOLA, CITROS, GOIABA, MANGA, MARACUJÁ, MELANCIA E PEPINO, PRINCIPALMENTE PELO FATO DE CAUSAR DANOS DIRETOS NO PRODUTO COMERCIAL, QUE SÃO OS FRUTOS.</span>")
		...
		self.Adictional[22].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: ATACA PRINCIPALMENTE AS FOLHAS E AS RAÍZES DA CANA DE AÇÚCAR. CANA-DE-AÇÚCAR, PASTAGENS, TODAS AS CULTURAS COM OCORRÊNCIA DO ALVO BIOLÓGICO.</span>")
		...
		self.Adictional[23].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: SEMENTE OU GRÃO, CAULE/RAMOS EM LAVOURAS EM GERAL.</span>")
		...
		self.Adictional[24].set_markup("<span foreground='#001000' size='x-large' face='Arial'><b>INFORMAÇÕES ADICIONAIS: </b>DANOS: SEMENTE OU GRÃO, CAULE/RAMOS EM LAVOURAS EM GERAL.</span>")
